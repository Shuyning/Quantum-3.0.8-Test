  ...
  public class AnimatorGraphAssetEditor : Editor
  {
      ...
      _asset = (AnimatorGraph)target;
        ...
        private void Export(object obj) {
            try {
                ...
                exportType.GetMethod("OnBake").Invoke(instance, new object[] { _asset });
    ...
    public override void OnInspectorGUI()
    {
      ...
      if (GUILayout.Button("Bake Animator Graph"))
      {
        ...
        var exportSubClasses = new List<Type>(typeof(AnimatorGraphBaker).GetSubClasses(AppDomain.CurrentDomain.GetAssemblies()));
        foreach (var es in exportSubClasses)
            Debug.Log(es);
        ...
        else 
        {
            ...
            {
                exportMenu.AddItem(new GUIContent($"Bake Using {exportSubClasses[i].Name}"), false, Export, exportSubClasses[i]);
            }
